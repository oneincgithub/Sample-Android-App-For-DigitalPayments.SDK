...
import com.digitalpayments.paymentform.android.sdk.builders.ErrorHandler;
import com.digitalpayments.paymentform.android.sdk.builders.PaymentCompleteHandler;
import com.digitalpayments.paymentform.android.sdk.builders.SaveCompleteHandler;
        ...
        onError = new ErrorHandler() {
            ...
            public void run() {
                ...
                if (getErrorResponse() != null
                        && getErrorResponse().getDescription() != null
                        && getErrorResponse().getDescription().contains("InternalServerError")
                        && paymentForm != null){
                    paymentForm.close();
                }
            }
